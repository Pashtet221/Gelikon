...
$global_benefits = gelikon_delivery_get_field('global_why_buy_items', [], 'option');
		...
		<section class="gl-card">
			...
			<div class="gl-delivery-cards gl-delivery-payments">
				<?php foreach ($payment_methods as $method) : ?>
					<article class="gl-delivery-card gl-delivery-card--iconed"><?php if (!empty($method['icon']['url'])) : ?><img class="gl-delivery-card__icon-image" src="<?php echo esc_url($method['icon']['url']); ?>" alt="" loading="lazy"><?php else : ?><span class="gl-delivery-card__icon" aria-hidden="true"></span><?php endif; ?><?php echo esc_html($method['title'] ?? ''); ?></article>
				<?php endforeach; ?>
			</div>
		</section>
